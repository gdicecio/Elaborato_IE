...
\begin{document}
	...
	\include{cap/benchmark}
	\include{cap/workload_caracterization}
	\include{cap/capacity_test}
	\include{cap/webserver_characterization}
	\include{cap/doe}
	\include{cap/dependability}
	\include{cap/ffdanalisis}
